...
pub(super) fn value_after_colon(line: &str) -> String {
...
pub(super) fn build_snapshot(ipcfg: &str, wlan: &str) -> NetworkSnapshot {
...
";
    ...
    fn value_with_colon_is_kept_intact() {
        ...
        assert_eq!(
            value_after_colon("    SSID                   : Corp:Net"),
            "Corp:Net"
        );
        assert_eq!(
            value_after_colon("   Default Gateway . . . : fe80::1"),
            "fe80::1"
        );
    }
