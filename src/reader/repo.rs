//! Persistence for the digit-reader log: append + read only. There is
//! deliberately no update or delete here — the absence of that API *is* the
...
// No writer exists until camera capture + inference are wired; until then
