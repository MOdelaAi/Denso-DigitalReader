...
/// Orient a frame for preview: compose the preset `degrees` rotation, the
/// camera `roll` (in-plane, about the view axis) and `pitch` (out-of-plane
/// tilt, rendered as a perspective warp). All angles in degrees; all-zero is
/// identity. Rotations pivot about the image centre.
